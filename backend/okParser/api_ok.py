...
class _API(object):
    ...
    def __init__(self, application_key, session_key, session_secret_key, data_format):
    ...
    def _signature(self, params):
        ...
        param_str += self.session_secret_key
...
class Odnoklassniki(_API):
    ...
    session_key=None, session_secret_key=None):
        if not (application_key or session_key or session_secret_key):  # None or empty string
